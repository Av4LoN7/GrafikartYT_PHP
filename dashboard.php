...
// lorsque l'on clique sur une année (icone) la liste des mois ou le site fut visité s'affiche en dessous ok
// afficher le nombre de visite pour le mois sélectionné ok
$nombreDeVuesTotal = getAllViewsNumber();
